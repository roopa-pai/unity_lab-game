...
public class DoorXenia : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.X) && enter)
        {
            open = !open;
        }
    }
    ...
    void OnGUI()
    {
        if (enter)
        {
            GUI.Label(new Rect(Screen.width / 2 - 75, Screen.height - 100, 150, 30), "Press 'X' to open the door");
            //if (gotkey == 1)
            //{
            //    GUI.Label(new Rect(Screen.width / 2 - 75, Screen.height - 100, 150, 30), "You have the key! /n Press 'F' to open the door");
            //}
            //else
            //{
            //    GUI.Label(new Rect(Screen.width / 2 - 75, Screen.height - 100, 150, 30), "You don't have the key! /n Go get the key from Xenia.");
            //}
        }
    }
